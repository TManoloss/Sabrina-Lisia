    ...
    <footer className="bg-balaio-green text-white">
      <div className="container-custom py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          {/* Sobre */}
          <div>
            <h3 className="font-serif text-xl mb-4">Sabrina Lisia</h3>
            <p className="text-white/80 text-sm leading-relaxed">
              Arquiteta e Urbanista. Criando espaços únicos e funcionais que refletem a identidade de cada cliente.
            </p>
          </div>
